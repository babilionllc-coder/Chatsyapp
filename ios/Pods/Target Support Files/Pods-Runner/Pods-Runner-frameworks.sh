...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/app_tracking_transparency/app_tracking_transparency.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/appvestor_billing_stats/appvestor_billing_stats.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/read_pdf_text/read_pdf_text.framework"
